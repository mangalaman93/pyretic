...
def define_operator_policy():
	default_policy1 = if_(match(dstmac = IPAddr('10.0.0.2'), switch = 1), fwd(3), flood())
	default_policy2 = if_(match(dstmac = IPAddr('10.0.0.2'), switch = 2), fwd(2), flood())
	default_policy3 = if_(match(dstmac = IPAddr('10.0.0.2'), switch = 3), fwd(3), flood())	
	
	default_policy5 = if_(match(dstmac = IPAddr('10.0.0.2'), switch = 4), fwd(1), flood())
	default_policy6 = if_(match(dstmac = IPAddr('10.0.0.2'), switch = 3), fwd(1), flood())
	default_policy7 = if_(match(dstmac = IPAddr('10.0.0.2'), switch = 2), fwd(1), flood())
